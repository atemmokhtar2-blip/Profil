  ...
  return <main className={intro ? "site intro-active" : "site"}>
    ...
    <section id="top" className="hero">
      ...
      <div className="hero-portrait" data-depth>
        ...
        <div className="portrait-name">Hatem<i className="brand-ring brand-ring-1"/><i className="brand-ring brand-ring-2"/><i className="brand-ring brand-ring-3"/><i className="brand-ring brand-ring-4"/><i className="brand-ring brand-ring-5"/><span className="portrait-arrow">↗</span><span className="portrait-caption">BUILD / CREATE / REPEAT</span></div>
      </div>
