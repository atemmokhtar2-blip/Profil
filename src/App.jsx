  ...
  return <main className={intro ? "site intro-active" : "site"}>
    ...
    <section id="top" className="hero">
      ...
      <div className="hero-portrait" data-depth>
        ...
        <div className={`portrait-name-wrap name-style-${nameStyle}`} aria-label="Hatem"><span className="portrait-name-live">{["HΛTEM","HATΞM","H4TEM","HATEM.","HΛTΞM","H·A·T·E·M"][nameStyle]}</span><span className="portrait-name-arrow" aria-hidden="true">↗</span></div>
      </div>
